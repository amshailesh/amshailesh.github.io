...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2020 at 10:17 AM
...
--
-- Database: `ganeshvardam_asm`
--
CREATE DATABASE IF NOT EXISTS `ganeshvardam_asm` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ganeshvardam_asm`;
