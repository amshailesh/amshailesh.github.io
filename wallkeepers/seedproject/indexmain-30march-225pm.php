...
include("dbconnect.php");
                        ...
                        if(isset($_SESSION["productmodel"])){
                            
                           echo "<h2 class='message'>You have selected processor. Click next button</h2>";
                            $sql="select * from processor where cpumodel='".$_SESSION["productmodel"]."'";
                        }
                        else{
...
while($res=mysqli_fetch_array($result)){
    ...
    echo "
                    ...
                    <td data-label='coreclock'>".$res["coreclock"]."</td>
                    <td data-label='boostclock'>".$res["boostclock"]."</td>
                    <td data-label='tdp'>".$res["tdp"]."</td>
                    ...
                    <td data-label='addcart'><a href='addproductcookie.php?iproductmodel=$cpumodel&icpusocket=$cpusocket&irelationname=$relationname' class='dispatch'>Add to cart</a></td></tr>
...
while($resmotherboard=mysqli_fetch_array($resultmotherboard)){
    ...
    echo "
                    ...
                    <td data-label='Max-Memory'>".$resmotherboard["motherboardmemorymax"]."</td>
                    ...
                    <td data-label='Add-cart'><a href='#' class='dispatch'>Add to cart</a></td></tr>";
}
