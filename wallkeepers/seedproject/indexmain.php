...
while($rescust=mysqli_fetch_array($resultcust)){
    ...
    echo "
    <form action='editcustomerinfo.php' method='get'>
    
                        <tr>
                    <td data-label='custid'>".$rescust["cust_id"]."</td>
                    <td data-label='name'>".$rescust["cust_name"]."</td>
                    <td data-label='password'><input type='text' value='".$rescust["password"]."' name='icpassword' /></td>
                    <td data-label='securityanswer'><input type='text' value='".$rescust["securityanswer"]."' name='isecurityanswer' /></td>
                    <td data-label='address'><textarea name='iaddress' rows='4' cols='50' >".$rescust["address"]."</textarea><input type='hidden' value='$cusername' name='icusername' /></td>
...
while($rescabinet=mysqli_fetch_array($resultcabinet)){
    ...
    echo "
                    ...
                    <td><a href='addproductcookie.php?iproductmodel=$casemodel&iprice=$caseprice' class='dispatch'>Add to cart</a></td></tr>";
...
while($res=mysqli_fetch_array($result)){
    ...
    echo "
                    ...
                    <td data-label='addcart'><a href='addproductcookie.php?iproductmodel=$cpumodel&icpusocket=$cpusocket&icputdp=$cputdp&icpubrand=$cpubrand&iramtype=$ramtype&iprice=$productprice&iqty=$productqty' class='dispatch'>Add to cart</a></td></tr>
...
while($rescpucooler=mysqli_fetch_array($resultcpucooler)){
    ...
    echo "
                    ...
                    <td data-label='Add-cart'><a href='addproductcookie.php?iproductmodel=$cpucoolermodel&iprice=$coolprice' class='dispatch'>Add to cart</a></td></tr>";
}
...
while($resmotherboard=mysqli_fetch_array($resultmotherboard)){
    ...
    echo "
                    ...
                    <td data-label='Add-cart'><a href='addproductcookie.php?iproductmodel=$motherboardmodel&iprice=$moprice' class='dispatch'>Add to cart</a></td></tr>";
}
...
while($resram=mysqli_fetch_array($resultram)){
    ...
    echo "
                    ...
                    <td data-label='Add-cart'><a href='addproductcookie.php?iproductmodel=$rammodel&iprice=$ramprice' class='dispatch'>Add to cart</a></td></tr>";
}
...
while($resgpu=mysqli_fetch_array($resultgpu)){
    ...
    echo "
                    ...
                    <td data-label='Add-cart'><a href='addproductcookie.php?iproductmodel=$gpumodel&igpuinterface=$gpuinterface&iprice=$gpuprice' class='dispatch'>Add to cart</a></td></tr>";
}
...
while($respsu=mysqli_fetch_array($resultpsu)){
    ...
    echo "
                    ...
                    <td data-label='Add-cart'><a href='addproductcookie.php?iproductmodel=$psumodel&iprice=$psuprice' class='dispatch'>Add to cart</a></td></tr>";
}
...
while($reshdd=mysqli_fetch_array($resulthdd)){
    ...
    echo "
                    ...
                    <td data-label='Add-cart'><a href='addproductcookie.php?iproductmodel=$hddmodel&iprice=$hddprice' class='dispatch'>Add to cart</a></td></tr>";
}
