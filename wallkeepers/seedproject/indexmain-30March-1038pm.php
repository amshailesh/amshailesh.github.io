...
while($res=mysqli_fetch_array($result)){
    ...
    echo "
                    ...
                    <td data-label='addcart'><a href='addproductcookie.php?iproductmodel=$cpumodel&icpusocket=$cpusocket&irelationname=$relationname&icputdp=$cputdp' class='dispatch'>Add to cart</a></td></tr>
...
while($rescpucooler=mysqli_fetch_array($resultcpucooler)){
    ...
    echo "
                    ...
                    <td data-label='cputdp'>".$rescpucooler["cputdp"]."</td>
